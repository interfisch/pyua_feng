			...
			<ORDER_INFO>	
				...
				<ORDER_HEADER>					
					...
					<xsl:choose>
            			...
            			<!-- Stand ISO Code-->
            			<xsl:otherwise>
							<BILLINGADDRESS_COUNTRY_CODE><xsl:value-of select="ORDER_HEADER/ORDER_INFO/ORDER_PARTIES/INVOICE_PARTY/PARTY/ADDRESS/COUNTRY" /></BILLINGADDRESS_COUNTRY_CODE>	
							<BILLINGADDRESS_NAME5>
					...
					<xsl:choose>
            			...
            			<!-- Stand ISO Code-->
            			<xsl:otherwise>
							<SHIPPINGADDRESS_COUNTRY_CODE><xsl:value-of select="ORDER_HEADER/ORDER_INFO/ORDER_PARTIES/BUYER_PARTY/PARTY/ADDRESS/COUNTRY" /></SHIPPINGADDRESS_COUNTRY_CODE>	
              			</xsl:otherwise>
          			</xsl:choose>		
