...
// fwrite($dateihandle, "class rtf \n");
    ...
    */
    ...
    {
	global $dateihandle;
		// fwrite($dateihandle, "parseControl mit  control=$control\n");
        switch ($control) {
    ...
    */
    ...
    {
		global $dateihandle;
		// fwrite($dateihandle, "flushControl mit  match[1]=".$match[1]."\n");
    ...
    */
    ...
    {
				global $dateihandle;
				// fwrite($dateihandle, "flushGroup mit  state=".$state."\n");
    ...
    {
	global $dateihandle;
	// fwrite($dateihandle, "checkHtmlSpanContent \n");
    ...
    */
	...
	global $dateihandle;
		...
		// fwrite($dateihandle, "flushQueue mit this->queue=".$this->queue." \n");
        ...
        if (strlen($this->queue)) {
			...
			// fwrite($dateihandle, "440 flushQueue mit this->queue=".$this->queue." \n");
            ...
            if (strlen($this->queue)) {
                ...
                */
                ...
                if ($this->wantHTML) {
							// fwrite($dateihandle, "453 flushQueue mit this->queue=".$this->queue." \n");
// fwrite($dateihandle, "454 this->flags[fonttbl_current_read]=".$this->flags["fonttbl_current_read"]." \n");
$rcm=true;
                    // only output html if a valid (for now, just numeric;) fonttable is given
                    if (ereg("^[0-9]+$", $this->flags["fonttbl_current_read"]) || $rcm) {
 			...
 			// fwrite($dateihandle, "473 flushQueue mit this->queue=".$this->queue." \n");
 			...
 			// fwrite($dateihandle, "479 flushQueue mit this->queue=".$this->queue." \n");

                        /* check if the span content has a modifier */
                        $this->checkHtmlSpanContent("start");
                        /* write span content */
						 			// fwrite($dateihandle, "484 flushQueue mit this->queue=".$this->queue." \n");

                        $this->out .= $this->queue;
                        /* close modifiers */
                        $this->checkHtmlSpanContent("stop");
						 			// fwrite($dateihandle, "489 flushQueue mit this->queue=".$this->queue." \n");
    ...
    */
	...
	global $dateihandle;
		...
		// fwrite($dateihandle, "flushSpecial mit special=".$special." \n");
 ...
 // fwrite($dateihandle, "laenge= ".$this->len."\n");

        while ($i < $this->len) {
             // fwrite($dateihandle, "this->rtf[$i]= ".$this->rtf[$i]."\n");
			switch ($this->rtf[$i]) {
                    ...
                    if ($this->cw) { // active control word ?
                        ...
                        */
                        ...
                        if (ereg("^[a-zA-Z0-9-]?$", $this->rtf[$i])) { // continue parsing
                            ...
                            */
                            ...
                            if (! $specialmatch) {
							 ...
							 // fwrite($dateihandle, "default6 mit  this->cword=". $this->cword."\n");
                        } 
                    } else {
					 		 // fwrite($dateihandle, "default7 mit  this->cword=". $this->cword."\n");
                        ...
                        if (($this->wantHTML) || ($this->wantXML)) {
						    ...
						    // fwrite($dateihandle, "default752 mit  this->queue=". $this->queue."\n");
                    } 
            } 
            $i++;
        } 
