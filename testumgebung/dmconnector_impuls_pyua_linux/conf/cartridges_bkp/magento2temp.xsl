      	...
      	<ORDER>
			...
			<ORDER_INFO>	
				...
				<ORDER_HEADER>					
					...
					<xsl:choose>
						<!-- Als Gast im Shop, dann Kundennummer = Order ID -->
              				<xsl:when test="ORDER_HEADER/ORDER_INFO/ORDER_PARTIES/BUYER_PARTY/PARTY/PARTY_ID = '0'">
              					<CUSTOMER_ID>-<!-- xsl:value-of select="ORDER_HEADER/ORDER_INFO/ORDER_CID"/ --></CUSTOMER_ID>
							</xsl:when>
            				...
            				<xsl:otherwise>
								<CUSTOMER_ID>
									<xsl:text></xsl:text><xsl:value-of select="200000+ORDER_HEADER/ORDER_INFO/ORDER_PARTIES/BUYER_PARTY/PARTY/PARTY_ID"/>
								</CUSTOMER_ID>
              				</xsl:otherwise>
          				</xsl:choose>	
					...
					<xsl:choose>
						<!-- Vorkasse -->
              			<xsl:when test="ORDER_HEADER/ORDER_INFO/PAYMENT/PAYMENT_TERM = 'bankpayment'">
              				<PAYMENTMETHOD>Vorkasse</PAYMENTMETHOD>	
							<PAYMENT_METHOD_ID>36</PAYMENT_METHOD_ID>
						</xsl:when>
						<!-- Nachnahme -->
						<xsl:when test="ORDER_HEADER/ORDER_INFO/PAYMENT/PAYMENT_TERM = 'cashondelivery'">
              				<PAYMENTMETHOD>Vorkasse</PAYMENTMETHOD>	
							<PAYMENT_METHOD_ID>36</PAYMENT_METHOD_ID>
						</xsl:when>
						<!-- Paypal -->
						<xsl:when test="ORDER_HEADER/ORDER_INFO/PAYMENT/PAYMENT_TERM = 'paypal_standard'">
              				<PAYMENTMETHOD>Vorkasse</PAYMENTMETHOD>	
							<PAYMENT_METHOD_ID>36</PAYMENT_METHOD_ID>
						</xsl:when>
						<!-- Standart: Vorkasse -->
					...
					<xsl:choose>
							<!-- Post Versand -->
              			<xsl:when test="ORDER_HEADER/ORDER_INFO/DELIVERY_METHOD = 'flatrate_flatrate'">
              				<SHIPPING_METHOD>6</SHIPPING_METHOD>
							<SHIPPING_KONDITION>AbWerk</SHIPPING_KONDITION>
						</xsl:when>
						<!-- Nachnahme Post Versand -->
						<xsl:when test="ORDER_HEADER/ORDER_INFO/PAYMENT/PAYMENT_TERM = 'cashondelivery'">
              				<SHIPPING_METHOD>6</SHIPPING_METHOD>
							<SHIPPING_KONDITION>AbWerk</SHIPPING_KONDITION>
						</xsl:when>
						<!-- inland -->
						<xsl:when test="ORDER_HEADER/ORDER_INFO/DELIVERY_METHOD = 'multipletablerates_bestway_79'">
              				<SHIPPING_METHOD>6</SHIPPING_METHOD>
							<SHIPPING_KONDITION>AbWerk</SHIPPING_KONDITION>
						</xsl:when>
						<!-- inland -->
						<xsl:when test="ORDER_HEADER/ORDER_INFO/DELIVERY_METHOD = 'tablerate_bestway'">
              				<SHIPPING_METHOD>6</SHIPPING_METHOD>
							<SHIPPING_KONDITION>AbWerk</SHIPPING_KONDITION>
						</xsl:when>
						<!-- Ausland -->
						<xsl:when test="contains(ORDER_HEADER/ORDER_INFO/DELIVERY_METHOD, 'multipletablerates_bestway')">
              				<SHIPPING_METHOD>6</SHIPPING_METHOD>
							<SHIPPING_KONDITION>AbWerk</SHIPPING_KONDITION>
						</xsl:when>
						<!-- inland -->
						<xsl:when test="ORDER_HEADER/ORDER_INFO/DELIVERY_METHOD = 'multipletablerates_bestway_53'">
              				<SHIPPING_METHOD>6</SHIPPING_METHOD>
							<SHIPPING_KONDITION>AbWerk</SHIPPING_KONDITION>
						</xsl:when>
						...
						<xsl:when test="ORDER_HEADER/ORDER_INFO/CUSTOMER_FOREIGN = '1'">
							<xsl:choose>
		              			<xsl:when test="ORDER_HEADER/ORDER_INFO/CUSTOMER_EU = '1'">
										...
										<xsl:choose>
											<xsl:when test="ORDER_HEADER/ORDER_INFO/ORDER_PARTIES/INVOICE_PARTY/PARTY/ADDRESS/VAT_ID = ''">
												<CUSTOMER_TAX_ID>5</CUSTOMER_TAX_ID>
											</xsl:when>
											<xsl:otherwise>
												<CUSTOMER_TAX_ID>2</CUSTOMER_TAX_ID>
											</xsl:otherwise>
										</xsl:choose>	
								</xsl:when>
								<!-- anderes Ausland -->
								<xsl:otherwise>
									...
									<CUSTOMER_TAX_ID>0</CUSTOMER_TAX_ID>
								</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<!-- Deutscher Kunde -->
					...
					<xsl:choose>
              			<xsl:when test="ORDER_HEADER/ORDER_INFO/ORDER_PARTIES/INVOICE_PARTY/PARTY/ADDRESS/COUNTRY_ISO_CODE = 'DE'">
						...
						<xsl:when test="ORDER_HEADER/ORDER_INFO/ORDER_PARTIES/INVOICE_PARTY/PARTY/ADDRESS/COUNTRY_ISO_CODE = 'AT'">
            			...
            			<xsl:otherwise>
							<BILLINGADDRESS_COUNTRY_CODE>
								<xsl:value-of select="ORDER_HEADER/ORDER_INFO/ORDER_PARTIES/INVOICE_PARTY/PARTY/ADDRESS/COUNTRY_ISO_CODE" />
							</BILLINGADDRESS_COUNTRY_CODE>	
							<BILLINGADDRESS_NAME5>
					...
					<xsl:choose>
              			<xsl:when test="ORDER_HEADER/ORDER_INFO/ORDER_PARTIES/BUYER_PARTY/PARTY/ADDRESS/COUNTRY_ISO_CODE = 'DE'">
              				<SHIPPINGADDRESS_COUNTRY_CODE>DE</SHIPPINGADDRESS_COUNTRY_CODE>
						</xsl:when>
						<xsl:when test="ORDER_HEADER/ORDER_INFO/ORDER_PARTIES/BUYER_PARTY/PARTY/ADDRESS/COUNTRY_ISO_CODE = 'AT'">
